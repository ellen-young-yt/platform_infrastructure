...
class TestSecretsManager:
    ...
    def test_secrets_manager_initialization(self, test_project_name, test_environment, mock_aws_region):
    ...
    def test_set_database_credentials_success(self, test_project_name, test_environment, mock_aws_region):
        ...
        with patch('boto3.client') as mock_boto3:
            ...
            assert call_args[1]['SecretId'] == f"{test_project_name}/{test_environment}/database/credentials"
    ...
    def test_set_database_credentials_failure(self, test_project_name, test_environment, mock_aws_region):
    ...
    def test_set_api_keys_filters_empty_values(self, test_project_name, test_environment, mock_aws_region):
    ...
    def test_list_secrets_success(self, test_project_name, test_environment, mock_aws_region):
        ...
        with patch('boto3.client') as mock_boto3:
            ...
            print_calls = [call for call in mock_print.call_args_list if call[0] and call[0][0].startswith('*')]
