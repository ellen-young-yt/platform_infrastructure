...
class SecretsManager:
    ...
    def set_database_credentials(self, username: str, password: str, host: str, 
    ...
    def set_api_keys(self, openai_api_key: str = "", github_token: str = "", 
                    slack_webhook_url: str = "", datadog_api_key: str = ""):
    ...
    def set_app_config(self, secret_key: str, jwt_secret: str, 
                      encryption_key: str, session_secret: str):
        ...
        try:
            ...
            print(f"[SUCCESS] App configuration updated successfully")
        except Exception as e:
...
def main():
    ...
    get_parser.add_argument('secret_type', help='Secret type (database/credentials, api/keys, app/config)')
    ...
    if args.command == 'set-db':
        secrets_manager.set_database_credentials(
            args.username, args.password, args.host,
            args.port, args.database, args.engine
        )
    
    elif args.command == 'set-api':
        secrets_manager.set_api_keys(
            args.openai_key or "", args.github_token or "",
            args.slack_webhook or "", args.datadog_key or ""
        )
    
    elif args.command == 'set-app':
        secrets_manager.set_app_config(
            args.secret_key, args.jwt_secret,
            args.encryption_key, args.session_secret
        )
